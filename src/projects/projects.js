...
export const Projects = () => {
    ...
    <section className='projects_container'>
       ...
       <div className='project_div'>
        <h1>Rad Rentals</h1>
        <a href='https://github.com/Trond240/Mod_3_V-RAD_APP'>Project Repo</a>
       ...
       <div className='project_div'>
        <h1>Space Age</h1>
        <a href='https://github.com/Trond240/Space-Age'>Project Repo</a>
       ...
       <div className='project_div'>
        ...
        <a href='https://github.com/Trond240/Dungeon-Crawler'>Project Repo</a>
       ...
       <div className='project_div'>
        ...
        <a href='https://github.com/Trond240/rancid-tomatillos-app'>Project Repo</a>
